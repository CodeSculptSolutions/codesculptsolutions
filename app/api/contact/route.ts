    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:540px;background:#FDFAF6;border-radius:6px;overflow:hidden;border:1px solid rgba(27,26,31,0.08);">
        ...
        <tr><td style="padding:40px 48px 32px;">
          ...
          <h1 style="margin:0;font-size:22px;font-weight:700;letter-spacing:-0.02em;color:#1B1A1F;">CodeSculptSolutions</h1>
        </td></tr>
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:540px;background:#FDFAF6;border-radius:6px;overflow:hidden;border:1px solid rgba(27,26,31,0.08);">
        ...
        <tr><td style="padding:32px 48px 0;">
          ...
          <p style="margin:12px 0 0;font-size:15px;font-weight:600;color:#1B1A1F;">— Jake, CodeSculptSolutions</p>
        </td></tr>
